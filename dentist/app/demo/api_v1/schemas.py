...
definitions = {'definitions': {'Dentists': {'type': 'object', 'properties': {'id': {'type': 'integer', 'format': 'int64'}, 'name': {'type': 'string'}, 'location': {'type': 'string'}, 'specialization': {'type': 'string'}}, 'example': {'id': 1, 'name': 'Promie', 'location': 'Marrickville', 'specialization': 'Paediatric Dentistry'}}}, 'parameters': {}}

validators = {
}

filters = {
    ('dentists', 'GET'): {200: {'headers': None, 'schema': {'$ref': '#/definitions/Dentists'}}},
}
