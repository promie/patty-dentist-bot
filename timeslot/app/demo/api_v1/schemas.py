...
filters = {
    ('dentists_did_timeslots', 'GET'): {200: {'headers': None, 'schema': {'type': 'object', 'properties': {'id': {'type': 'string'}, 'times': {'type': 'object'}}, 'example': {'id': 'Patrick', 'times': {'Mon 9am-10am': 'available', 'Mon 10am-11am': 'available', 'Mon 11am-12pm': 'reserved', 'Mon 12pm-1pm': 'reserved', 'Mon 1pm-2pm': 'available', 'Mon 2pm-3pm': 'reserved', 'Mon 3pm-4pm': 'available', 'Mon 4pm-5pm': 'available'}}}}, 404: {'headers': None, 'schema': None}},
    ('dentists_did_timeslots_tid_reserve', 'PUT'): {200: {'headers': None, 'schema': {'type': 'object', 'properties': {'message': {'type': 'string'}}, 'example': {'message': 'Your appointment with Patrick for Mon 9am-10am has been confirmed.'}}}, 404: {'headers': None, 'schema': None}},
    ('dentists_did_timeslots_tid_cancel', 'PUT'): {200: {'headers': None, 'schema': {'type': 'object', 'properties': {'message': {'type': 'string'}}, 'example': {'message': 'Your cancellation with Patrick for Mon 9am-10am has been confirmed.'}}}, 404: {'headers': None, 'schema': None}},
}
